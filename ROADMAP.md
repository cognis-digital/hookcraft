...
- Niche focus: Frida is powerful but everyone copy-pastes the same gist scripts; hookcraft is a templated, versioned, MCP-native generator so an AI agent can request instrumentation declaratively..
