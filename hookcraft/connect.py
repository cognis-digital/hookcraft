"""Native cognis-connect emit for hookcraft — forward findings to any platform.

Maps hookcraft's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    hookcraft ... --format json | hookcraft-emit --to stix
    hookcraft-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
