#!/usr/bin/env sh
# Universal installer for hookcraft. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/hookcraft.git"
echo "Installing hookcraft ..."
